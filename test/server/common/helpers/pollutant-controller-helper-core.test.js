...
describe('pollutant-controller-helper - basic functionality', () => {
  let mockRequest
  let mockH
...
describe('pollutant-controller-helper - Welsh redirects with all query params', () => {
  let mockRequest
  let mockH
...
describe('pollutant-controller-helper - error handling', () => {
  let mockRequest
  let mockH
...
describe('pollutant-controller-helper - view context data', () => {
  let mockRequest
  let mockH
