...
export const footerTranslations = {
  footer: {
    privacy: {
      ...
      paragraphs: {
        a: `This privacy notice explains how the ${SERVICE_NAME} service processes and shares your ${PERSONAL_DATA}. If you have any queries about the content of this privacy notice, please email`,
        b: `Department for Environment, Food and Rural Affairs (Defra) is the controller for the ${PERSONAL_DATA} we collect:`,
        c: 'Department for Environment, Food and Rural Affairs',
        d: 'Seacole Building',
        e: '2 Marsham Street',
        f: 'London',
        g: 'SW1P 4DF',
        h: `If you need further information about how Defra uses your ${PERSONAL_DATA} and your associated rights you can contact the Defra data protection manager at `,
        ...
        q: `The legal basis for processing your ${PERSONAL_DATA} to conduct research on the effectiveness of the service is consent. You do not have to provide your consent and you can withdraw your consent at any time.`,
        r: `The processing of your ${PERSONAL_DATA} is based on consent. We do not collect any information that could be personally linked to an individual; however, the IP address will be recorded for functionality of the service.`,
        ...
        s: `We do not share the ${PERSONAL_DATA} collected under this privacy notice with other organisations.`,
        ...
        u: `We will keep your ${PERSONAL_DATA} for 7 years in line with legislative requirements which is 7 years.`,
        w: 'for advice on retention period that you need to state here.',
        x: `If you do not provide the ${PERSONAL_DATA} of the postcode or location that you are searching for, then you will not be able to use our service as we will not be able to provide you any data.`,
        y: `The other ${PERSONAL_DATA} is optional and only required for service improvement.`,
        z: `The ${PERSONAL_DATA} you provide is not used for:`,
        a0: 'automated decision making (making a decision by automated means without any human involvement)',
        a1: `profiling (automated processing of ${PERSONAL_DATA} to evaluate certain things about an individual)`,
        a2: `We will only transfer your ${PERSONAL_DATA} to another country that is deemed adequate for data protection purposes.`,
        ...
        a22: `explains more about your rights over your ${PERSONAL_DATA}.`,
        a23: 'You can',
        a24: 'opt in and out of cookie acceptance.'
      },
      description: `${SERVICE_NAME} takes your privacy seriously. Read this Privacy Policy to learn how we treat your ${PERSONAL_DATA}.`
    },
    cookies: {
      title: 'Cookies',
