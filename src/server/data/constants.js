...
export const DAQI_INDEX_HIGH_START = 7
export const DAQI_INDEX_VERY_HIGH = 10
...
export const TWENTY_MINUTES_IN_MS = Number.parseInt('20', 10) * 60 * 1000
export const THIRTY_MINUTES_IN_MS = Number.parseInt('30', 10) * 60 * 1000
