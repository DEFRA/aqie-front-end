 ...
 * @returns Back link configuration with text, url, and display flag
 */
 ...
 * @returns Back link configuration for search location page
 */
 ...
 * @returns Back link configuration for location page
 */
