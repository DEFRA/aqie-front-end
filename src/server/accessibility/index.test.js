...
describe('Nunjucks Template', () => {
  ...
  it('should render the page title correctly', () => {
    ...
    expect(result).toContain('<h1 class="govuk-heading-xl odd-page">Accessibility Page</h1>');
  });
  ...
  it('should render paragraphs and headings correctly', () => {
    ...
    expect(result).toContain('<a href="https://check-air-quality.service.gov.uk/">https://check-air-quality.service.gov.uk/</a>');
