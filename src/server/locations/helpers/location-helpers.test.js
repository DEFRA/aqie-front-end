...
describe('location-helpers', () => {
  ...
  describe('combineUKSearchTerms', () => {
    it('should combine search terms when not a valid postcode', () => {
      ...
      expect(result).toBe('manchester city')
  ...
  describe('buildUKApiUrl', () => {
    it('should build UK API URL with encoded parameters', () => {
      ...
      expect(result).toContain(encodeURIComponent('manchester city'))
      expect(result).toContain('fq=' + encodeURIComponent('LOCAL_TYPE:City'))
  ...
  describe('isMockEnabled', () => {
    ...
    it('should return the same value across repeated calls', () => {
      const firstResult = isMockEnabled()
      const secondResult = isMockEnabled()
