...
function mergeConfigs(...t) {
  function flattenObject(t) {
    const e = {}
    return (
      (function flattenLoop(t, i) {
        for (const [n, s] of Object.entries(t)) {
          const t = i ? `${i}.${n}` : n
          s && typeof s === 'object' ? flattenLoop(s, t) : (e[t] = s)
        }
      })(t),
      e
    )
...
function normaliseString(t) {
  ...
  return (
    e === 'true' ||
    (e !== 'false' && (e.length > 0 && isFinite(Number(e)) ? Number(e) : t))
  )
}
...
class ElementError extends GOVUKFrontendError {
  constructor(t) {
    ...
    if (typeof t === 'object') {
      const { componentName: i, identifier: n, element: s, expectedType: o } = t
      ;(e = `${i}: ${n}`),
        (e += s
...
class I18n {
  ...
  t(t, e) {
    ...
    typeof (e == null ? void 0 : e.count) === 'number' &&
  ...
  getPluralSuffix(t, e) {
    ...
    const i = this.hasIntlPluralRulesSupport()
          ...
          : t === 2
            ...
            : t % 100 >= 3 && t % 100 <= 10
              ...
              : t % 100 >= 11 && t % 100 <= 99
                ...
                : 'other',
    chinese: () => 'other',
    french: (t) => (t === 0 || t === 1 ? 'one' : 'other'),
    german: (t) => (t === 1 ? 'one' : 'other'),
    irish: (t) =>
      t === 1
        ? 'one'
        : t === 2
      ...
      t === 1 || t === 11
        ...
        : t === 2 || t === 12
          ...
          : (t >= 3 && t <= 10) || (t >= 13 && t <= 19)
            ...
            : 'other',
    spanish: (t) =>
      t === 1 ? 'one' : t % 1e6 == 0 && t !== 0 ? 'many' : 'other',
    welsh: (t) =>
      t === 0
        ? 'zero'
        : t === 1
...
class Accordion extends GOVUKFrontendComponent {
  ...
  constructHeaderMarkup(t, e) {
    ...
    for (const u of Array.from(i.attributes))
      u.nodeName !== 'id' && o.setAttribute(u.nodeName, `${u.nodeValue}`)
    ...
    if (
      ...
      for (const i of Array.from(s.attributes))
        t.setAttribute(i.nodeName, `${i.nodeValue}`)
  ...
  setInitialState(t) {
    if (this.browserSupportsSessionStorage && this.config.rememberExpanded) {
      ...
      if (e) {
        ...
        const n = i ? window.sessionStorage.getItem(i) : null
        n !== null && this.setExpanded(n === 'true', t)
      }
    }
  }
...
class ExitThisPage extends GOVUKFrontendComponent {
  ...
  handleKeypress(t) {
    this.$updateSpan &&
      ((t.key !== 'Shift' && t.keyCode !== 16 && t.which !== 16) ||
  ...
  setFocus() {
    this.config.disableAutoFocus ||
      (this.$module.getAttribute('role') === 'alert' &&
        (this.$module.getAttribute('tabindex') ||
          (this.$module.setAttribute('tabindex', '-1'),
          this.$module.addEventListener('blur', () => {
            this.$module.removeAttribute('tabindex')
          })),
...
class SkipLink extends GOVUKFrontendComponent {
  constructor(t) {
    ...
    const n = (e = this.$module.getAttribute('href')) != null ? e : ''
    let s
    try {
    ...
    ;(this.$linkedElement = r),
      this.$module.addEventListener('click', () => this.focusLinkedElement())
  }

  focusLinkedElement() {
    this.$linkedElement &&
      (this.$linkedElement.getAttribute('tabindex') ||
...
class Tabs extends GOVUKFrontendComponent {
  constructor(t) {
    ...
    const n = this.$module.querySelectorAll('li.govuk-tabs__list-item')
    if (!i)
      throw new ElementError({
        componentName: 'Tabs',
...
function initAll(t) {
  ...
  const n = (e = t.scope) != null ? e : document
  i.forEach(([t, e]) => {
