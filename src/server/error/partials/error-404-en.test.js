...
describe('Nunjucks Template', () => {
  ...
  it('should render the error-404-en template correctly', () => {
    const context = {
      notFoundUrl: {
        nonService: {
          heading: 'Page not found',
          paragraphs: {
            a: 'Sorry, we cannot find the page you are looking for.',
    ...
    const result = env.render('error-404-en.njk', context)
