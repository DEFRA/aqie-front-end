...
function renderWelshLocationView(h, viewData) {
  const {
    locationDetails,
    airQuality,
    airQualityData: airQualityDataLocal,
    nearestLocationsRange,
    siteTypeDescriptions: siteTypeDescriptionsLocal,
    pollutantTypes: pollutantTypesLocal,
    pageTitle,
    metaSiteUrl,
    description,
    title,
  ...
  return h.view('locations/location', {
    ...
    airQuality,
    airQualityData: airQualityDataLocal.commonMessages,
