...
describe('SMS Send Activation Controller', () => {
  ...
  test('handleSendActivationPost processes valid request and redirects', () => {
    const mockRequest = {
      yar: {
        get: vi.fn().mockReturnValue('07123456789'),
        set: vi.fn()
    ...
    handleSendActivationPost(mockRequest, mockH)
  ...
  test('handleSendActivationPost redirects when no mobile number in session', () => {
    const mockRequest = {
      yar: {
